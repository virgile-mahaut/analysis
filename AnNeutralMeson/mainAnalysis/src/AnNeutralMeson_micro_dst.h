...
class AnNeutralMeson_micro_dst : public SubsysReco
{
 ...
 private:
  ...
  TH1F *h_pair_meson_eta_pt[nParticles][nPtBins] = {nullptr};
  TH1F *h_pair_meson_xf_pt[nParticles][nPtBins] = {nullptr};
  TH1F *h_meson_pt[nParticles] = {nullptr};
  TH1F *h_meson_E[nParticles] = {nullptr};
